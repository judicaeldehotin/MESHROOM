...
'''
    ...
    inputs = [
       ...
       desc.ChoiceParam(
        ...
        desc.BoolParam(
            name='sgmDoVolumeOptimization',
            label='SGM: Do Volume Optimization',
            description='Semi Global Matching: Perfom similarity volume optimization.',
            value=True,
            uid=[0],
            advanced=True,
        ),
        ...
        desc.IntParam(
            name='sgmSmoothXYZVolumeRadius',
            label='SGM: Smooth XYZ Volume Radius',
            description='Semi Global Matching: Radius of the similarity 3d gaussian smooth to perform (if <= 0, do nothing).',
            value=-1,
            range=(-1, 200, 1),
            uid=[0],
            advanced=True,
        ...
        desc.IntParam(
            name='refineSmoothXYZVolumeRadius',
            label='Refine: Smooth XYZ Volume Radius',
            description='Refine: Radius of the similarity 3d gaussian smooth to perform (if <= 0, do nothing).',
            value=-1,
            range=(-1, 200, 1),
            uid=[0],
            advanced=True,
        ...
        desc.IntParam(
            name='refineSmoothZVolumeRadius',
            label='Refine: Smooth Z Volume Radius',
            description='Refine: Radius of the similarity 1d Z gaussian smooth to perform (if <= 0, do nothing).',
            value=-1,
            range=(-1, 30, 1),
            uid=[0],
            advanced=True,
        ...
        desc.BoolParam(
            ...
            label='Refine: Do Refine Fuse',
            description='Refine: Perfom RefineFuse algorithm.',
            value=True,
            uid=[0],
            advanced=True,
        ),
        desc.BoolParam(
            name='refineDoRefineFuseLegacy',
            label='Refine: Do Refine Fuse Legacy',
            description='Refine: Perfom RefineFuse legacy algorithm.',
            value=False,
            uid=[0],
            advanced=True,
        ),
        desc.BoolParam(
            name='refineDoVolumeOptimization',
            label='Refine: Do Volume Optimization',
            description='Refine: Perfom similarity volume optimization.',
            value=True,
            uid=[0],
            advanced=True,
        ),
        desc.BoolParam(
            name='refineDoDepthSimMapOptimization',
            label='Refine: Do Depth Sim Map Optimization',
            description='Refine: Perfom depth/sim map optimization.',
            value=True,
            uid=[0],
            advanced=True,
        ),
        desc.BoolParam(
            name='refineInterpolateRetrieveBestDepth',
            label='Refine: Interpolate Retrieve Best Depth',
            description='Refine: interpolate retrieve best depth.',
            value=True,
            uid=[0],
            advanced=True,
        ),
